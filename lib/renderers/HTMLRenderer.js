...
var HTMLRenderer = exports.HTMLRenderer = function (_BaseRenderer) {
    ...
    function HTMLRenderer(options) {
        ...
        _this.el.style.color = _this.options.color;
    ...
    _createClass(HTMLRenderer, [{
        ...
        value: function render(image) {
            ...
            // }
            var renderer = monoRenderer(this.el);
        ...
        value: function createGradient() {
            ...
            var gradient = this.options.gradient.map(function (color, index) {
                return color + " " + index / (_this2.options.gradient.length - 1) * 100 + "%";
            }).join(', ');
...
function colorRenderer(el) {
    var wrapInColor = function wrapInColor(_ref) {
        var char = _ref.char,
            ...
            b = _ref.b,
            a = _ref.a;
        return "<span style=\"color: rgba(" + r + ", " + g + ", " + b + ", " + a + ")\">" + char + "</span>";
    };
